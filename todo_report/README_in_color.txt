...
./bin/crontab-verbose:23:    # EASY FUN [1m[31mTODO^139[0m[0m: (TESTING,  IN_PROGRESS NOW) also open example files, if available (so Zerothlife can suggest an example crontab file)
