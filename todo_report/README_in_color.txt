...
[1m[33m./bin/git-ready:83:exit_with_error "There are still outstanding changes at $(pwd)" # TESTING IN_PROGRESS NOW [1m[31mTODO^336[0m[1m[33m: only exit 0 if there is nothing to commit[0m
