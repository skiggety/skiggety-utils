...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ showing last 8 lines out of 612: ^
./installers/skiggety.bash.config/bashrc_section.bash:21:# [1m[31mTODO^294[0m[0m IN_PROGRESS NOW: upgrade asdf--does this need a change?:
...
[1m[33m./bin/review_v0.1:4:# [1m[31mTODO^709[0m[1m[33m IN_PROGRESS?: PAUSE the cycle when user has been inactive for more than SOME_DAMN_SETTING by default, to save resources..[0m
