...
./installers/signal:14:      raise NotImplementedError, '[1m[31mTODO^141[0m[0m: (IN_PROGRESS, NOW): IMPLEMENT this for this OS'
./installers/signal:37:  # [1m[31mTODO^141[0m[0m: (IN_PROGRESS, NOW) IMPLEMENT: ...
[1m[33m./bin/vital:12:# [1m[31mTODO^189[0m[1m[33m: (URGENT, IN_PROGRESS, NOW) vital must help you set up, connect, and use a private repo for vital data, then[0m
