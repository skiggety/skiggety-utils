...
./bin/today_todo:74:    # [1m[31mTODO^190[0m[0m: (IN_PROGRESS, NOW) also most of these paragraphs could be function extracted...:
...
./installers/vital:8:# [1m[31mTODO^190[0m[0m: (TESTING IN_PROGRESS, NOW) this call to that other script thingy:
[1m[33m./bin/today_todo:117:        # [1m[31mTODO^192[0m[1m[33m: (TESTING IN_PROGRESS NOW) here, or maybe in the actual 'vital' script, we need to commit/push changes[0m
