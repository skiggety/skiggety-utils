...
./installers/zerothlife:6:# [1m[31mTODO^139[0m[0m: (IN_PROGRESS, NOW) TEST this script
[1m[33m./installers/zerothlife:9:# - [1m[31mTODO^139[0m[1m[33m: (IN_PROGRESS, NOW) make this, and maybe all installers, optional.  We could use marker files to keep track of[0m
