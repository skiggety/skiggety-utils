...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ showing last 8 lines out of 585: ^
./bin/vital:72:# [1m[31mTODO^189[0m[0m: (IN_PROGRESS, NOW) make plans to clean up archives better
...
./bin/git-ready:59:    run-or-fail git dashboard # [1m[31mTODO^332[0m[0m IN_PROGRESS TESTING NOW trying to use this for its exit value
[1m[33m./bin/git-ready:76:exit 0 # TESTING IN_PROGRESS NOW [1m[31mTODO^335[0m[1m[33m: only exit 0 if there is nothing to commit[0m
