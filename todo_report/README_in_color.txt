...
./installers/zerothlife:9:# - [1m[31mTODO^139[0m[0m: (IN_PROGRESS) make this, and maybe all installers, optional.  We could use marker files to keep track of
[1m[33m./README.md:126:  - [1m[31mTODO^140[0m[1m[33m: (IN_PROGRESS, NOW) merge PR, after moving 'firstlife' data (to do list) to private repo ("zerothlife")[0m
