...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ showing last 8 lines out of 619: ^
./lib/include_in_bashrc.bash:81:# (IN_PROGRESS) TODO^294: DELETE???: . "$HOME/.asdf/completions/asdf.bash"
./installers/basic_prerequisites:163:# TODO^295 IN_PROGRESS NOW: upgrade to asdf 0.16.0 or later ( open 'https://asdf-vm.com/guide/upgrading-to-v0-16#breaking-changes' )
