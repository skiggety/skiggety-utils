...
./bin/vital:68:# TODO^190: (URGENT, IN_PROGRESS, NOW) vital must help you set up, connect, and use a private repo for vital data, then
./bin/today_todo:82:    # TODO^191: (IN_PROGRESS, NOW) also most of these paragraphs could be function extracted...:
./bin/today_todo:126:        # TODO^191: (TESTING IN_PROGRESS NOW) test this bit on tinhat:
./installers/vital:8:# TODO^191: (TESTING IN_PROGRESS, NOW) this call to that other script thingy:
./bin/today_todo:125:        # TODO^192: (TESTING IN_PROGRESS NOW) test this bit on metrigon:
