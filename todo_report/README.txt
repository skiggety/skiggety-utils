...
./bin/git-attempt-checkout:3:# TODO^8: RENAME this script.  How about "git-findout"?
./bin/review:214:  # TODO^9: soft minimum, where it always *tries* to wait, say, long enough for you to react, but then still wakes up
