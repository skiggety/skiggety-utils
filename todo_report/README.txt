...
./bin/vital:33:    # TODO^96: and make an alias to help add todo's quick:
...
./installers/signal:37:  # TODO^141: (IN_PROGRESS, NOW) IMPLEMENT: ...
./bin/vital:12:# TODO^189: (URGENT, IN_PROGRESS, NOW) vital must help you set up, connect, and use a private repo for vital data, then
