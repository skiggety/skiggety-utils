...
alias brush='zl-fork "zl-size-terminal -n 8;sleep-verbose --vv 10;zl-groom-terminal-window-locations --multiple 20"'
alias brushy='zl-fork "zl-size-terminal -n 8;sleep-verbose --vv 10;zl-groom-terminal-window-locations --multiple 20";exit 0'
