...
export ZEROTHLIFE_CODE_DIR="$HARDCODED_ZEROTHLIFE_CODE_DIR"                                        # FROM_SKIGGETY_UTILS
source $ZEROTHLIFE_CODE_DIR/config/include_in_bashrc.bash                                          # FROM_SKIGGETY_UTILS
                                                                                                   # FROM_SKIGGETY_UTILS
